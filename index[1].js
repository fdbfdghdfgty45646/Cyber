...
// путь к картинке-баннеру, которая будет снизу в Embed
const BANNER_IMAGE_PATH = './images/lobby-banner.png';
...
async function sendLobbyMessage(textChannel, hostMember) {
  ...
  const embed = new EmbedBuilder()
    .setColor(0xFF7A00) // цвет полоски слева
    .setDescription(
      `**Вы создали лобби на CyberStand!**\n\n` +
      `**Хост лобби:** <@${hostMember.id}>\n\n` +
      `**Режим лобби:** DUELS`
    )
    .setImage('attachment://lobby-banner.png'); // картинка снизу текста
